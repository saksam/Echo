...
import com.example.saksham.echo.adapter.FavoriteAdapter
...
class FavoriteFragment : Fragment() {
    ...
    fun bottomBarClickHandler() {
        ...
        nowPlayingBottomBar?.setOnClickListener({
            ...
            statified.musicPlayer = SongPlayingFragment.stat.mediaPlayer
