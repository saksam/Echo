...
class SettingFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val prefs=myActivity?.getSharedPreferences(stati.MY_PREFS_NAME,Context.MODE_PRIVATE)
        ...
        shakeSwitch?.setOnCheckedChangeListener({compoundButton, b ->
            ...
            if(b){
                val editor=myActivity?.getSharedPreferences(stati.MY_PREFS_NAME,Context.MODE_PRIVATE)?.edit()
